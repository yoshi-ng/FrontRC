    ...
    >
      <div style={{ display: "flex" }}>
        <div style={{ padding: 40, flex: 1 }}>
          <h1 style={{ color: "#fff", fontSize: "45px", marginBottom: "24px" }}>
            Nuestro contacto
          </h1>
          <div style={{ marginBottom: "24px" }}>
            <p
              style={{ color: "#fff", fontSize: "24px", marginBottom: "20px" }}
            >
              ¿Tienes preguntas o necesitas más información?
            </p>
            <p style={{ color: "#fff", fontSize: "24px" }}>
              Escríbenos a nuestro whatsapp y con gusto te ayudamos
            </p>
          </div>
          <div>
